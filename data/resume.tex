...
\begin{enumerate}[label={[\arabic*]},labelsep=6pt,topsep=0pt,partopsep=0pt,
parsep=0pt,itemsep=1pt,leftmargin=0em,itemindent=42pt]
  \item Shu Wenyu, Jiang Chunyun, Zhan Ronghui, Guo Yue, Chen Shiqi.
  Few-shot unsupervised domain adaptation for SAR target recognition based on input alignment and class confusion loss.
  In: 2024 IEEE International Conference on Signal, Information and Data Processing (ICSIDP), 2024: 1--5.
  \item Shu Wenyu, Zhan Ronghui, Chen Shiqi, Guo Yue, Zhang Huiqiang.
  ...
  Remote Sensing, 2025, 17(17): 2966.
\end{enumerate}
