...
\confidentiality{公开}
\UDC{}
\title{实测数据受限条件下的跨域SAR目标识别技术研究}
\displaytitle{实测数据受限条件下的跨域SAR目标识别技术研究}
\author{束文郁}
\zhdate{\zhtoday}
\entitle{Research on Cross-Domain SAR Target Recognition Technology Under Real-Data Limited Conditions}
\enauthor{SHU Wenyu}
\endate{\entoday}
\subject{信息与通信工程}
\ensubject{Information and Communication Engineering}
\researchfield{智能目标识别}
\supervisor{占荣辉\quad{}副教授}
\cosupervisor{} % 没有就空着
\ensupervisor{Prof. ZHAN Ronghui}
