...
\confidentiality{公开}
\UDC{}
\title{数据受限条件下的跨域SAR目标识别\\方法研究}
\displaytitle{数据受限条件下的跨域SAR目标识别\\方法研究}
\author{束文郁}
\zhdate{\zhtoday}
\entitle{Research on Cross-Domain SAR Target Recognition Methods Under Real-Data Limited Conditions}
\enauthor{SHU Wenyu}
\endate{\entoday}
\subject{信息与通信工程}
